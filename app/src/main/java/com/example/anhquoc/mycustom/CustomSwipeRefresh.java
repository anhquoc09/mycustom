...
public class CustomSwipeRefresh extends ViewGroup implements NestedScrollingParent,
...
//        setColorViewAlpha(MAX_ALPHA);
    ...
    private void createProgressView() {
        ...
        mCircleView = new SimpleDraweeView(getContext());
        mCircleView.setLayoutParams(new LinearLayout.LayoutParams(31, 67));
